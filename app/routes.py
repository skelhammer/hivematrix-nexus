...
def inject_side_panel(soup, current_service, user_data=None):
    ...
    service_icons = {
        ...
        'beacon': '<svg viewBox="0 0 24 24"><path d="M4.9 16.1C1 12.2 1 5.8 4.9 1.9"/><path d="M7.8 13.2c-2.3-2.3-2.3-6.1 0-8.5"/><path d="M10.8 10.2c-1.3-1.3-1.3-3.4 0-4.8"/><circle cx="12" cy="8" r="2"/><path d="M13.2 5.8c1.3 1.3 1.3 3.4 0 4.8"/><path d="M16.2 2.8c2.3 2.3 2.3 6.1 0 8.5"/><path d="M19.1 -0.1C23 3.8 23 10.1 19.1 14"/><path d="M12 12v10"/></svg>',
        'archive': '<svg viewBox="0 0 24 24"><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M7 4v3a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4"/><path d="M12 12h.01"/></svg>'
    }
